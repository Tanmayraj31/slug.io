...
> Status: **in progress** — Waves 10.1–10.4 (security headers/CORS/body limit, per-group rate limiting, Vitest + supertest test infrastructure with a dedicated test DB, and unit tests for pure business logic) are implemented, verified, and committed. Remaining: Wave 10.5 integration/E2E tests, Wave 10.6 wrap-up.
